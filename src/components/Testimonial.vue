<template>
  <div class="relative bg-black dark:bg-transparent">
    <template v-if="type.toLowerCase() === 'marketing'">
      <swiper
        :loop="true"
        slidesPerView="auto"
        :spaceBetween="30"
      ...
      >
            ...
            <div class="w-full max-w-[570px] lg:mt-[150px]">
              <div class="rounded-3xl bg-gray-dark p-6">
                ...
                <div class="relative mt-12">
                  <h5 class="font-extrabold text-primary">
                    {{ feedback.name }}
                  </h5>
        ...
        <div class="bottom-0 z-[1] mt-5 flex items-center justify-end gap-4 ltr:right-28 rtl:left-28 sm:absolute sm:mt-0 sm:justify-end">
          ...
          <button
            type="button"
            class="swiper-button-prev2 static mt-0 flex h-10 w-10 items-center justify-center rounded-full bg-white/5 transition after:text-[0px] hover:bg-secondary rtl:rotate-180"
          >
          ...
          <button
            type="button"
            class="swiper-button-next2 static mt-0 flex h-10 w-10 items-center justify-center rounded-full bg-white/5 transition after:text-[0px] hover:bg-secondary rtl:rotate-180"
          >
            <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
    ...
    <template v-else>
      <div v-if="type.toLowerCase() === 'common'" class="absolute top-0 ltr:right-0 rtl:left-0 rtl:-rotate-180">
      ...
      <div v-if="type.toLowerCase() === 'modern-saas'" class="absolute top-0 ltr:left-1/4 rtl:right-1/4 rtl:rotate-y-180">
      ...
      <div v-if="type.toLowerCase() === 'modern-saas'" class="absolute top-1/4 hidden ltr:right-4 rtl:left-4 rtl:rotate-y-180 lg:block">
      ...
      <div class="container">
        ...
        <div class="mx-auto" :class="{ 'lg:w-11/12': type.toLowerCase() === 'common' }">
          <swiper
            ...
            :dir="store.direction === 'rtl' ? 'rtl' : 'ltr'"
            :key="store.direction === 'rtl' ? 'true' : 'false'"
            class="relative sm:!py-12 md:!py-0"
          >
            <template v-if="type.toLowerCase() === 'common'">
              <swiper-slide v-for="feedback in feedbacks" :key="feedback.id">
            ...
            <template v-if="type.toLowerCase() === 'modern-saas'">
              <swiper-slide v-for="feedback in feedbacks" :key="feedback.id">
            ...
            <div
              ...
              :class="{
                'ltr:right-1/3 rtl:left-1/3 sm:absolute sm:mt-0 sm:justify-end': type.toLowerCase() === 'common',
