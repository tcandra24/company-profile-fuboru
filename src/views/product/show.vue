      ...
      <div class="container">
        ...
        <div class="py-7 md:py-10">
          ...
          <div class="flex gap-3 flex-col sm:flex-row">
            <div class="p-2 dark:bg-gray-dark">
              <div class="aspect-video">
                <blockquote
                  class="instagram-media"
                  data-instgrm-permalink="https://www.instagram.com/p/DL_0jmDxPy2/?utm_source=ig_embed&amp;utm_campaign=loading"
                ...
                >
                  <div style="padding: 16px">
                    <a
                      href="https://www.instagram.com/p/DL_0jmDxPy2/?utm_source=ig_embed&amp;utm_campaign=loading"
                    ...
                    >
                      <a
                        ...
                        "
                        target="_blank"
                        >A post shared by Fuboru | Simply the best (@fuboruindonesia)</a
                      >
                    </p>
                  </div>
                </blockquote>
            ...
            <div class="p-2 dark:bg-gray-dark">
              <div class="aspect-video">
                <blockquote
                  class="instagram-media"
                  data-instgrm-permalink="https://www.instagram.com/reel/DJ09q0vRApK/?utm_source=ig_embed&amp;utm_campaign=loading"
                  data-instgrm-version="14"
                  style="
                    background: #fff;
                    border: 0;
                ...
                >
                  <div style="padding: 16px">
                    <a
                      href="https://www.instagram.com/reel/DJ09q0vRApK/?utm_source=ig_embed&amp;utm_campaign=loading"
                      style="background: #ffffff; line-height: 0; padding: 0 0; text-align: center; text-decoration: none; width: 100%"
                      target="_blank"
                    >
                      <div style="display: flex; flex-direction: row; align-items: center">
            ...
            <div class="p-2 dark:bg-gray-dark">
              <div class="aspect-video">
                <iframe
                  ...
                  height="631"
                  class="h-full w-full"
                  src="https://www.youtube.com/embed/9PHjY8SYd_s"
                  title="Pakai Gear Set Fuboru, Tarikan Motor Jadi ENTENG BANGET! Cek Buktinya!"
                  frameborder="0"
